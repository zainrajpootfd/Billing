  ...
  return (
    <div className="fixed bottom-5 right-10 md:right-5 flex items-center gap-3 z-50 ">
      ...
      <a
        ...
        className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white p-1 md:px-4 md:py-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 animate-bounce"
